-- Bootstrap corrigido do schema tenant em banco compartilhado.
-- As referências circulares/antecipadas são adicionadas sem FK inicial para permitir a criação ordenada.
-- Criar extensões
